...
public class ZXSC_XZSHDZ extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String id = sharedUtils.getShared("id", ZXSC_XZSHDZ.this);
        String newid = id;
        ...
        switch (v.getId()) {
            case R.id.xzshdz_diqu:
                ...
                task.setCallback(new AddressPickTask.Callback() {
                    ...
                    public void onAddressInitFailed() {
                        Toast.makeText(ZXSC_XZSHDZ.this, "数据初始化失败", Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.xzshdz_bc:
                ...
                if (trim.equals("") || trim2.equals("") || trim3.equals("") || trim4.equals("")) {
                    ToSi.show(ZXSC_XZSHDZ.this, "信息未填写完整");
                }  else if (!mobileNO){
            ...
            if (msg.what==200){
                ...
                try {
                    ...
                    if ("0".equals(status)){
                        ...
                        ToSi.show(ZXSC_XZSHDZ.this,status+info);
                    }
