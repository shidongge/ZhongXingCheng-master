...
import us.mifeng.zhongxingcheng.liaotian.AddFriendActivity;
import us.mifeng.zhongxingcheng.liaotian.ProfileActivity;
...
public class FriendProfile implements ProfileSummary {
    ...
    public void onClick(Context context) {
        if (FriendshipInfo.getInstance().isFriend(profile.getIdentifier())) {
            ...
            person.putExtra("avaterUrl", profile.getFaceUrl());
