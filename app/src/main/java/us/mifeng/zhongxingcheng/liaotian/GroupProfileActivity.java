...
public class GroupProfileActivity extends FragmentActivity implements GroupInfoView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img = (CircleImageView) findViewById(R.id.avatar);
    ...
    public void showGroupInfo(List<TIMGroupDetailInfo> groupInfos) {
        ...
        if (!TextUtils.isEmpty(faceUrl)) {
            Glide.with(GroupProfileActivity.this).load(faceUrl).into(img);
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnChat:
                ...
                sharedUtils.saveShared("REFRESH_TAG", groupId, GroupProfileActivity.this);
                break;
            case R.id.btnDel:
                if (isGroupOwner) {
            ...
            case R.id.member:
                ...
                intentGroupMem.putExtra("groupId", groupId);
            ...
            case R.id.messageNotify:
                ...
                new ListPickerDialog().show(messageOptList, getSupportFragmentManager(), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, final int which) {
                        ...
                        Log.e(TAG, "onClick: " + UserInfo.getInstance().getId());
            ...
            if (data != null && requestCode == IMAGE_PICKER) {
                ...
                TIMGroupManagerExt.getInstance().modifyGroupInfo(param, new TIMCallBack() {
                    ...
                    public void onError(int code, String desc) {
                        Log.e("00", "modify group info failed, code:" + code + "|desc:" + desc);
                    }

                    @Override
                    public void onSuccess() {
                        Log.e("00", "modify group info succ");
                        Glide.with(GroupProfileActivity.this).load(path).into(img);
                        sharedUtils.saveShared("REFRESH_TAG", groupId, GroupProfileActivity.this);
                    }
                });
            } else {
