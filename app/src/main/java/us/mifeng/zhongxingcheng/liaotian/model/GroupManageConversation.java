...
import us.mifeng.zhongxingcheng.liaotian.GroupManageMessageActivity;
...
public class GroupManageConversation extends Conversation{
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()) {
            case INVITED_BY_OTHER:
                if (isSelf) {
                    return MyApplicaiton.getContext().getResources().getString(R.string.summary_me) +
                            MyApplicaiton.getContext().getResources().getString(R.string.summary_group_invite) +
                            to +
                            MyApplicaiton.getContext().getResources().getString(R.string.summary_group_add);
                } else {
                    if (to.equals(UserInfo.getInstance().getId())) {
                        return from +
                                MyApplicaiton.getContext().getResources().getString(R.string.summary_group_invite) +
                                MyApplicaiton.getContext().getResources().getString(R.string.summary_me) +
                                MyApplicaiton.getContext().getResources().getString(R.string.summary_group_add);
                    } else {
                        return from +
                                MyApplicaiton.getContext().getResources().getString(R.string.summary_group_invite) +
            ...
            case APPLY_BY_SELF:
                if (isSelf) {
                    return MyApplicaiton.getContext().getResources().getString(R.string.summary_me) +
                            MyApplicaiton.getContext().getResources().getString(R.string.summary_group_apply) +
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                } else {
                    return from + MyApplicaiton.getContext().getResources().getString(R.string.summary_group_apply) + GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return MyApplicaiton.getContext().getString(R.string.conversation_system_group);
    }
